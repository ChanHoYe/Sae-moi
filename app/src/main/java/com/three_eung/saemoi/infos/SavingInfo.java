...
public class SavingInfo implements Cloneable {
    ...
    public SavingInfo(String title, long value, int count, String startDate) {
        this.title = title;
        this.value = value;
        this.count = count;
    ...
    public SavingInfo(String title, long value, int count, String startDate, ArrayList<String> savedDate) {
        this.title = title;
        this.value = value;
        this.count = count;
        this.startDate = startDate;
